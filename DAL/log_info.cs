...
namespace DAL
{
	...
	public partial class log_info
	{
		...
		public bool Add(Model.log_info model)
		{
			...
			MySqlParameter[] parameters = {
					new MySqlParameter("@log_num", MySqlDbType.Int32,64),
					new MySqlParameter("@log_type", MySqlDbType.Int32,8),
		...
		/// 删除一条数据
		/// </summary>
		public bool Delete(int log_num)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.log_info GetModel(int log_num)
		{
