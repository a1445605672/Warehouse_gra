...
namespace DAL
{
	...
	public partial class staff
	{
		...
		/// 是否存在该记录
		/// </summary>
		public bool Exists(int staff_id)
		{
		...
		public bool Add(Model.staff model)
		{
			...
			strSql.Append("staff_id,staff_name,staff_sex,staff_identity_card,staff_phone_number,staff_age,staff_hire_date,staff_belong_dep_id)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select staff_id,staff_name,staff_sex,staff_identity_card,staff_phone_number,staff_age,staff_hire_date,staff_belong_dep_id ");
