...
namespace DAL
{
	...
	public partial class storage
	{
		...
		public bool Add(Model.storage model)
		{
			...
			strSql.Append("storage_name,storage_create_time,storage_area,storage_remain_chest,storage_remain_seat,storage_comment)");
		...
		public bool Update(Model.storage model)
		{
			...
			MySqlParameter[] parameters = {
					...
					new MySqlParameter("@storage_remain_seat", MySqlDbType.Int32,32),
					new MySqlParameter("@storage_comment", MySqlDbType.VarChar,255),
					new MySqlParameter("@storage_id", MySqlDbType.Int32,32)};
			parameters[0].Value = model.storage_name;
			parameters[1].Value = model.storage_create_time;
			parameters[2].Value = model.storage_area;
			parameters[3].Value = model.storage_remain_chest;
		...
		/// 删除一条数据
		/// </summary>
		public bool Delete(int storage_id)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.storage GetModel(int storage_id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select storage_id,storage_name,storage_create_time,storage_area,storage_remain_chest,storage_remain_seat,storage_comment from storage ");
			strSql.Append(" where storage_id=@storage_id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@storage_id", MySqlDbType.Int32)
			};
		...
		public Model.storage DataRowToModel(DataRow row)
		{
			...
			if (row != null)
			{
				if(row["storage_id"]!=null && row["storage_id"].ToString()!="")
				{
					model.storage_id=int.Parse(row["storage_id"].ToString());
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select storage_id,storage_name,storage_create_time,storage_area,storage_remain_chest,storage_remain_seat,storage_comment ");
