	...
	public partial class enter_storage
	{
		...
		public bool Add(Model.enter_storage model)
		{
			...
			MySqlParameter[] parameters = {
					...
					new MySqlParameter("@enter_sl_id", MySqlDbType.Int32,32),
					new MySqlParameter("@enter_amount", MySqlDbType.Decimal,15),
					new MySqlParameter("@enter_unit_bulk", MySqlDbType.Decimal,15),
					new MySqlParameter("@supplier_id", MySqlDbType.Int32,32),
					new MySqlParameter("@enter_mat_id", MySqlDbType.Int32,32),
					new MySqlParameter("@enter_mat_name", MySqlDbType.VarChar,255),
					new MySqlParameter("@enter_fengji_num", MySqlDbType.Int32,128),
					new MySqlParameter("@enter_date", MySqlDbType.DateTime),
					new MySqlParameter("@enter_agent_id", MySqlDbType.Int32,32),
		...
		public Model.enter_storage DataRowToModel(DataRow row)
		{
			...
			if (row != null)
			{
				...
				if(row["enter_sl_id"]!=null && row["enter_sl_id"].ToString()!="")
				{
				...
				if(row["enter_mat_id"]!=null && row["enter_mat_id"].ToString()!="")
				{
				...
				if(row["enter_fengji_num"]!=null && row["enter_fengji_num"].ToString()!="")
				{
				...
				if(row["enter_agent_id"]!=null && row["enter_agent_id"].ToString()!="")
				{
