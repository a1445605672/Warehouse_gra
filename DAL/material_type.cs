...
namespace DAL
{
	...
	public partial class material_type
	{
        ...
        public bool Add(Model.material_type model)
        {
            ...
            strSql.Append("type_id,type_name,type_comment,type_sx)");
        ...
        public bool Update(Model.material_type model)
        {
            ...
            parameters[2].Value = model.type_sx;
        ...
        public Model.material_type GetModel(string type_id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select type_id,type_name,type_comment,type_sx from material_type ");
            strSql.Append(" where type_id=@type_id ");
            MySqlParameter[] parameters = {
					new MySqlParameter("@type_id", MySqlDbType.VarChar,128)			};
            parameters[0].Value = type_id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select type_id,type_name,type_comment,type_sx ");
