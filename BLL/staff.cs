...
namespace BLL
{
	...
	public partial class staff
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.staff GetModelByCache(int staff_id)
		{
			...
			if (objModel == null)
			{
				try
				{
					objModel = dal.GetModel(staff_id);
					if (objModel != null)
					{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.staff> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.staff> DataTableToList(DataTable dt)
		{
			List<Model.staff> modelList = new List<Model.staff>();
