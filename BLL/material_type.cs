...
namespace BLL
{
	...
	{
		private readonly DAL.material_type dal=new DAL.material_type();
		...
		public Model.material_type GetModelByCache(string type_id)
		{
			...
			return (Model.material_type)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.material_type> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.material_type> DataTableToList(DataTable dt)
		{
			List<Model.material_type> modelList = new List<Model.material_type>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.material_type model;
